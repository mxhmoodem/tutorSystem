...
const SEED_TEACHERS = [
  { id:'t1', name:'Heebz A',  subject:'Mathematics',         classes:4, students:29, hwToMark:7, attendance:96, rating:4.9, joined:'Sep 2023', email:'s.clarke@centre.co.uk', phone:'07700 900111', status:'active',  color:'#4F46E5', account:{ status:'active', setupMethod:'self-set', invitedOn:'2023-08-28', activatedOn:'2023-09-01', employmentType:'Full-time', internalNotes:'Head of Maths.' } },
  ...
  { id:'t12',name:'Nadia Hassan',  subject:'Psychology',          classes:0, students:0,  hwToMark:0, attendance:0,  rating:0,   joined:'Jun 2026', email:'n.hassan@centre.co.uk', phone:'07700 900122', status:'invited', color:'#0EA5E9', account:{ status:'invited', setupMethod:'pending', inviteToken:'tok-nadia-2206', invitedOn:'2026-06-20', employmentType:'Part-time', internalNotes:'' } },
];
...
const SEED_CLASSES = [
  { id:'c1',  name:'GCSE Mathematics',     group:'Year 10 – Group A', teacher:'Heebz A', day:'Friday',    time:'09:00–10:30', room:'Room 3', students:8,  capacity:10, status:'active', tags:['GCSE'] },
  { id:'c2',  name:'GCSE Mathematics',     group:'Year 11 – Group B', teacher:'Heebz A', day:'Friday',    time:'10:30–12:00', room:'Room 3', students:7,  capacity:10, status:'active', tags:['GCSE','Exam Year'] },
  { id:'c3',  name:'A-Level Mathematics',  group:'Year 12 – Group A', teacher:'Heebz A', day:'Friday',    time:'13:00–14:30', room:'Room 5', students:5,  capacity:8,  status:'active', tags:['A-Level'] },
  { id:'c4',  name:'GCSE Mathematics',     group:'Year 9 – Group C',  teacher:'Heebz A', day:'Friday',    time:'15:00–16:30', room:'Room 3', students:9,  capacity:10, status:'active', tags:['GCSE'] },
  ...
  // ── Additional Heebz A (Maths) sessions across the week — fill out her
  ...
  { id:'c34', name:'GCSE Mathematics',     group:'Year 10 – Group C', teacher:'Heebz A',  day:'Monday',    time:'09:00–10:30', room:'Room 3', students:7,  capacity:12, status:'active', tags:['GCSE'] },
  { id:'c35', name:'A-Level Mathematics',  group:'Year 13 – Group A', teacher:'Heebz A',  day:'Wednesday', time:'13:00–14:30', room:'Room 5', students:5,  capacity:8,  status:'active', tags:['A-Level','Exam Year'] },
  { id:'c36', name:'GCSE Mathematics',     group:'Year 11 – Group C', teacher:'Heebz A',  day:'Tuesday',   time:'11:00–12:30', room:'Room 3', students:6,  capacity:12, status:'active', tags:['GCSE','Exam Year'] },
  { id:'c37', name:'A-Level Further Maths', group:'Year 12 – Group A', teacher:'Heebz A', day:'Thursday',  time:'09:00–10:30', room:'Room 5', students:4,  capacity:8,  status:'active', tags:['A-Level'] },
...
const SEED_STUDENTS = [
  { id:'s1', firstName:'Emma',     lastName:'Thompson',  year:'Yr 10', dob:'2009-04-12', email:'emma.t@email.com',    phone:'07700 901001', address:'12 Oak Lane, Leeds',     subjects:['Mathematics','English'], classIds:['c1','c8'], guardianName:'Karen Thompson', guardianRelation:'Mother', guardianEmail:'k.thompson@email.com', guardianPhone:'07700 911001', notes:'', attendance:91, hw:82, score:76, status:'active',  teacher:'Heebz A / Marcus Webb', lastSeen:'Today', account:{ status:'active', setupMethod:'pin', username:'ethompson', syntheticEmail:'ethompson@brightminds.students.tutoros.app', underThirteen:false, consentRecorded:false, createdVia:'csv', provisionedOn:'2025-09-01', claimedOn:'2025-09-03' } },
  { id:'s2', firstName:'Oliver',   lastName:'Chen',      year:'Yr 12', dob:'2007-09-03', email:'oliver.c@email.com',  phone:'07700 901002', address:'4 Elm Court, Leeds',     subjects:['Mathematics','Further Maths','Physics'], classIds:['c3','c37','c20'], guardianName:'Wei Chen', guardianRelation:'Father', guardianEmail:'w.chen@email.com', guardianPhone:'07700 911002', notes:'', attendance:98, hw:96, score:94, status:'active', teacher:'Heebz A / David Park', lastSeen:'Today', account:{ status:'active', setupMethod:'password', dailyMethod:'password', username:'ochen', syntheticEmail:'ochen@brightminds.students.tutoros.app', underThirteen:false, consentRecorded:false, provisionedOn:'2023-09-01', claimedOn:'2023-09-04' } },
  { id:'s3', firstName:'Sophia',   lastName:'Patel',     year:'Yr 10', dob:'2009-01-22', email:'sophia.p@email.com',  phone:'07700 901003', address:'88 Birch Rd, Leeds',     subjects:['Mathematics'], classIds:['c1'], guardianName:'Anita Patel', guardianRelation:'Mother', guardianEmail:'a.patel@email.com', guardianPhone:'07700 911003', notes:'', attendance:88, hw:74, score:68, status:'active', teacher:'Heebz A', lastSeen:'Yesterday' },
  { id:'s4', firstName:'James',    lastName:'Wilson',    year:'Yr 11', dob:'2008-06-30', email:'james.w@email.com',   phone:'07700 901004', address:'21 Maple Ave, Leeds',    subjects:['Mathematics','Science'], classIds:['c2','c6'], guardianName:'Paul Wilson', guardianRelation:'Father', guardianEmail:'p.wilson@email.com', guardianPhone:'07700 911004', notes:'', attendance:85, hw:71, score:71, status:'active', teacher:'Heebz A / Priya Nair', lastSeen:'Yesterday' },
  ...
  { id:'s6', firstName:'Noah',     lastName:'Fitzgerald',year:'Yr 10', dob:'2009-02-17', email:'noah.f@email.com',    phone:'07700 901006', address:'33 Willow St, Leeds',    subjects:['Mathematics','Science'], classIds:['c1','c5'], guardianName:'Sean Fitzgerald', guardianRelation:'Father', guardianEmail:'s.fitz@email.com', guardianPhone:'07700 911006', notes:'', attendance:68, hw:48, score:55, status:'at-risk', teacher:'Heebz A / Priya Nair', lastSeen:'8 Apr' },
  { id:'s7', firstName:'Isabella', lastName:'Martinez',  year:'Yr 12', dob:'2007-07-14', email:'bella.m@email.com',   phone:'07700 901007', address:'15 Pine Way, Leeds',     subjects:['Mathematics','Further Maths'], classIds:['c3'], guardianName:'Carmen Martinez', guardianRelation:'Mother', guardianEmail:'c.martinez@email.com', guardianPhone:'07700 911007', notes:'', attendance:97, hw:95, score:91, status:'active', teacher:'Heebz A', lastSeen:'Today' },
  { id:'s8', firstName:'Ethan',    lastName:'Huang',     year:'Yr 11', dob:'2008-03-25', email:'ethan.h@email.com',   phone:'07700 901008', address:'2 Ash Grove, Leeds',     subjects:['Mathematics','Physics'], classIds:['c2'], guardianName:'Li Huang', guardianRelation:'Father', guardianEmail:'l.huang@email.com', guardianPhone:'07700 911008', notes:'', attendance:93, hw:88, score:83, status:'active', teacher:'Heebz A / David Park', lastSeen:'Today' },
  { id:'s9', firstName:'Mia',      lastName:'Okonkwo',   year:'Yr 9',  dob:'2010-05-19', email:'mia.o@email.com',     phone:'07700 901009', address:'9 Rowan Dr, Leeds',      subjects:['Science','English'], classIds:['c5','c8'], guardianName:'Grace Okonkwo', guardianRelation:'Mother', guardianEmail:'g.okonkwo@email.com', guardianPhone:'07700 911009', notes:'', attendance:95, hw:90, score:79, status:'active', teacher:'Priya Nair / Marcus Webb', lastSeen:'Yesterday', account:{ status:'active', setupMethod:'pin', dailyMethod:'pin', username:'mokonkwo', syntheticEmail:'mokonkwo@brightminds.students.tutoros.app', underThirteen:false, pinSet:true, consentRecorded:false, provisionedOn:'2023-09-01', claimedOn:'2023-09-05' } },
  ...
  // ── New cohort (round 2) — mostly Heebz A's maths classes so they flow
  ...
  { id:'s16', firstName:'Harry',   lastName:'Brooks',    year:'Yr 9',  dob:'2010-02-10', email:'', phone:'', address:'9 Sandhill Way, Leeds', subjects:[], classIds:[], guardianName:'Paul Brooks', guardianRelation:'Father', guardianEmail:'paul.brooks@email.com', guardianPhone:'07700 901016', notes:'', attendance:0, hw:0, score:0, status:'active', teacher:'—', lastSeen:'Not yet active', account:{ status:'pending', setupMethod:'pending', username:'hbrooks', syntheticEmail:'hbrooks@brightminds.students.tutoros.app', underThirteen:false, consentRecorded:false, createdVia:'single', provisionedOn:'2026-06-22', claimCode:'BM-7QK2' } },
  { id:'s17', firstName:'Lily',    lastName:'Nguyen',    year:'Yr 7',  dob:'2014-05-20', email:'', phone:'', address:'14 Mill Court, Leeds',   subjects:[], classIds:[], guardianName:'Mai Nguyen', guardianRelation:'Mother', guardianEmail:'mai.nguyen@email.com', guardianPhone:'07700 901017', notes:'', attendance:0, hw:0, score:0, status:'active', teacher:'—', lastSeen:'Not yet active', account:{ status:'invited', setupMethod:'pending', username:'lnguyen', syntheticEmail:'lnguyen@brightminds.students.tutoros.app', underThirteen:true, consentRecorded:false, createdVia:'csv', provisionedOn:'2026-06-22', claimCode:'BM-3MX9' } },
];
...
const allStudents = [
  { name:'Emma Thompson',    year:'Yr 10', subjects:['Mathematics','English'],     attendance:91, hw:82, score:76, status:'active',   teacher:'Ms. A / Mr. Webb',  lastSeen:'Today'     },
  { name:'Oliver Chen',      year:'Yr 12', subjects:['Mathematics','Further Maths','Physics'], attendance:98, hw:96, score:94, status:'active', teacher:'Ms. A / Mr. Park', lastSeen:'Today' },
  { name:'Sophia Patel',     year:'Yr 10', subjects:['Mathematics'],              attendance:88, hw:74, score:68, status:'active',   teacher:'Ms. A',             lastSeen:'Yesterday' },
  { name:'James Wilson',     year:'Yr 11', subjects:['Mathematics','Science'],    attendance:85, hw:71, score:71, status:'active',   teacher:'Ms. A / Ms. Nair',  lastSeen:'Yesterday' },
  ...
  { name:'Noah Fitzgerald',  year:'Yr 10', subjects:['Mathematics','Science'],    attendance:68, hw:48, score:55, status:'at-risk',  teacher:'Ms. A / Ms. Nair',  lastSeen:'8 Apr'     },
  { name:'Isabella Martinez',year:'Yr 12', subjects:['Mathematics','Further Maths'], attendance:97, hw:95, score:91, status:'active', teacher:'Ms. A',            lastSeen:'Today'     },
  { name:'Ethan Huang',      year:'Yr 11', subjects:['Mathematics','Physics'],   attendance:93, hw:88, score:83, status:'active',   teacher:'Ms. A / Mr. Park',  lastSeen:'Today'     },
  ...
  { name:'Aiden Foster',     year:'Yr 9',  subjects:['Mathematics'],              attendance:94, hw:85, score:81, status:'active',   teacher:'Ms. A',             lastSeen:'Today'     },
  { name:'Priya Nair',       year:'Yr 10', subjects:['Computer Science','Mathematics'], attendance:90, hw:79, score:75, status:'active', teacher:'Ms. A / Mr. Mehta', lastSeen:'Today' },
