...
const SEED_TEACHERS = [
  { id:'t1', name:'Sarah Clarke',  subject:'Mathematics',         classes:4, students:29, hwToMark:7, attendance:96, rating:4.9, joined:'Sep 2023', email:'s.clarke@centre.co.uk', phone:'07700 900111', status:'active',  color:'#4F46E5', account:{ status:'active', setupMethod:'self-set', invitedOn:'2023-08-28', activatedOn:'2023-09-01', employmentType:'Full-time', internalNotes:'Head of Maths.' } },
...
const SEED_STUDENTS = [
  { id:'s1', firstName:'Emma',     lastName:'Thompson',  year:'Yr 10', dob:'2009-04-12', email:'emma.t@email.com',    phone:'07700 901001', address:'12 Oak Lane, Leeds',     subjects:['Mathematics','English'], classIds:['c1','c8'], guardianName:'Karen Thompson', guardianRelation:'Mother', guardianEmail:'k.thompson@email.com', guardianPhone:'07700 911001', notes:'', attendance:91, hw:82, score:76, status:'active',  teacher:'Sarah Clarke / Marcus Webb', lastSeen:'Today', account:{ status:'active', setupMethod:'pin', username:'ethompson', syntheticEmail:'ethompson@brightminds.students.tutoros.app', underThirteen:false, consentRecorded:false, createdVia:'csv', provisionedOn:'2025-09-01', claimedOn:'2025-09-03' } },
