...
const COMMS_ANNOUNCEMENTS = [
  ...
  },
  {
    ...
    priority: 'normal', pinned: true, requiresAck: false,
    createdAt: _ago(10 * HOUR), expiresAt: '2026-07-03',
    reads: { u_sarah: _ago(9 * HOUR) }, acks: {},
  },
  {
    ...
    priority: 'important', pinned: false, requiresAck: true,
    createdAt: _ago(12 * HOUR), expiresAt: '2026-06-20',
    reads: { u_david: _ago(11 * HOUR) }, acks: { u_david: _ago(11 * HOUR - 5) },
  },
  {
    ...
    priority: 'normal', pinned: false, requiresAck: false,
    createdAt: _ago(16 * HOUR), expiresAt: null,
    reads: {}, acks: {},
  },
  {
    ...
    priority: 'normal', pinned: false, requiresAck: false,
    createdAt: _ago(20 * HOUR), expiresAt: null,
    reads: { u_oliver: _ago(19 * HOUR) }, acks: {},
  },
  {
    id: 'an_class_c13_practical',
    scope: 'class', centreId: 'bm', classId: 'c13',
    authorId: 'u_david', authorName: 'David Park', authorRole: 'teacher',
    audience: { centreIds: ['bm'], roles: ['student'], classIds: ['c13'] },
    title: 'A-Level Physics — required practical write-up',
    body: 'Great work in today’s resistivity practical. Please complete your write-up (method, results table, % uncertainty and evaluation) and submit before Thursday so I can give feedback ahead of the mock.',
    priority: 'normal', pinned: false, requiresAck: true,
    createdAt: _ago(2 * HOUR), expiresAt: null,
    reads: {}, acks: {},
  },
  {
    ...
    priority: 'normal', pinned: false, requiresAck: false,
    createdAt: _ago(30 * MIN), publishAt: new Date(_now + 2 * DAY * 60000).toISOString(), expiresAt: null,
    reads: {}, acks: {},
  },
  {
    ...
    priority: 'normal', pinned: false, requiresAck: false,
    createdAt: _ago(3 * DAY), expiresAt: null,
    reads: { u_sarah: _ago(3 * DAY - 40), u_oliver: _ago(3 * DAY - 120) }, acks: {},
  },
